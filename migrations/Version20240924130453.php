 ...
 */
final class Version20240924130453 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6499EC6B0EE FOREIGN KEY (voted_id) REFERENCES proposal (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
